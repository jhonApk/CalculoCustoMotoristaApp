 ...
 * Use the [CalculoCombustivelFragment.newInstance] factory method to
...
class CalculoCombustivelFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CalculoCombustivelFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CalculoCombustivelFragment().apply {
